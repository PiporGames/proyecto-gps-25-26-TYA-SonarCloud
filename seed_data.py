...
AUTH_TOKEN = "ddc2124b7896adcfba7e1467293f303ba963a1262ef413f796115a6166309507c50e502a15f9d2fca466ad67088aa2894ae5692cdf3180d13f4af1c23c2c5689"
cookies = {"oversound_auth": AUTH_TOKEN}
TEST_IMAGE = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAIAQMAAAD+wSzIAAAABlBMVEX///+/v7+jQ3Y5AAAADklEQVQI12P4AIX8EAgALgAD/aNpbtEAAAAASUVORK5CYII="
...
merch_data = [
    {"title": "Luna Eclipse - Official T-Shirt", "description": "Camiseta oficial negra con logo holográfico. 100% algodón orgánico. Tallas disponibles: S, M, L, XL", "price": 29.99, "cover": TEST_IMAGE},
    {"title": "Shadows & Echoes Vinyl LP", "description": "Edición limitada en vinilo de 180g. Incluye poster exclusivo y código de descarga digital.", "price": 34.99, "cover": TEST_IMAGE},
    {"title": "Luna Eclipse Tote Bag", "description": "Bolsa de tela resistente con diseño exclusivo. Perfecta para conciertos y uso diario.", "price": 19.99, "cover": TEST_IMAGE},
    {"title": "Cosmic Journey Hoodie", "description": "Sudadera con capucha premium. Diseño bordado del álbum Cosmic Journey. 80% algodón, 20% poliéster.", "price": 49.99, "cover": TEST_IMAGE},
    {"title": "Luna Eclipse Poster Set", "description": "Set de 3 posters de alta calidad (30x40cm). Diseños exclusivos de los álbumes y arte conceptual.", "price": 24.99, "cover": TEST_IMAGE}
]
